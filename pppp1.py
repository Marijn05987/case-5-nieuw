...
with tab4:
    ...
    if not filtered_data_week.empty:
        ...
        # Voeg een checkbox toe voor het tonen van de tabel
        show_table = st.checkbox("Toon tabel met data voor geselecteerde week", value=False)

        # Toon de tabel alleen als de checkbox is aangevinkt
        if show_table:
